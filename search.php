<?php  
	require('top.php');
    $str=mysqli_escape_string($con,$_GET['str']);
    if ($str!='') {
            ...
            <div class="container">
                <div class="row">
                                            ...
                                            <div class="category">
                                                <div class="ht__cat__thumb">
                                                    <a href="product.php?id=<?php echo $list['id']; ?>">
                                                        <img height="290" width="290" src="<?php echo PRODUCT_IMAGE_SITE_PATH.$list['image']; ?>" alt="product images">
                                                    </a>
                                                </div> 
                    ...
                    <?php
                        ...
                        {
                            echo "<center>";
                            echo "Nous n'avons pas trouvé de produits correspondant à votre recherche";
                            echo "</center>";
                        }
                    ?>    
                    </div>
